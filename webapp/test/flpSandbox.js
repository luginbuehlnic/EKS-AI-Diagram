		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#chnicmapsample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"chnicmapsample-display": {
								"semanticObject": "chnicmapsample",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ch.nic.mapsample",
									"url": sap.ui.require.toUrl("ch/nic/mapsample")
								}
							}
						}
					}
